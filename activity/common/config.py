...
import time
import os
# appurl='http://api2.chinajoinin.com/app/10000002.html'
# apploginname='13011116666'
# apppassword='00000000'
...
password='11111111'
# url='http://admin.join-inapp.com/public#/login'
# loginname='13499999999'
# password='33333333'
# url='http://huake.edu.chinajoinin.com'
# loginname='19920180001'
# password='11111111'
class configPage:
    """
    ...
    def find_elements(self, locator, timeout=3):
        ...
        return elements
    def send_keyboard(self,locator,keys):
    ...
    def is_exists(self, locator):
        '''判断元素存在'''
        try:
            self.is_located(locator,timeout=1)
            return True
        except:
            return False
